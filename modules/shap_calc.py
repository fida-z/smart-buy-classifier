...
print("SHAP MODULE:", shap)
print("SHAP FILE:", shap.__file__)
print("SHAP VERSION:", getattr(shap, "__version__", "NO VERSION"))
print("HAS TREEEXPLAINER:", hasattr(shap, "TreeExplainer"))
